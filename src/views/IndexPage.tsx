      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
          ...
          <div>
            ...
            {hasDrinks && (
              <p className="text-slate-400 text-sm mt-1">
                Found {drinks.drinks.length}{" "}
                {drinks.drinks.length === 1 ? "recipe" : "recipes"}
              </p>
            )}

            {isLoading && (
              <p className="text-slate-400 text-sm mt-1 animate-fade-in">
                Mixing the perfect drinks for you…
              </p>
            )}
          </div>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-slate-400 max-w-md font-light mb-8">
              Search by ingredients, explore categories, or discover something
              new. Your next signature drink is just a search away.
            </p>
