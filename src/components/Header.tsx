                    ...
                    <div className="w-full md:w-64 relative">
                      ...
                      {categoryOpen && (
                        <>
                          ...
                          <ul className="absolute top-full mt-2 w-full rounded-lg bg-slate-900/95 backdrop-blur-xl shadow-2xl border border-primary/30 max-h-72 overflow-y-auto z-120">
