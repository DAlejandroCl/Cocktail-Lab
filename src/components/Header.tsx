...
export default function Header() {
  ...
  return (
    <header>
      ...
      {isHome && (
        <>
          <section className="pt-12 pb-16 text-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="font-serif text-5xl md:text-7xl text-white mb-6 leading-tight">
              Discover Your Next <br />
              <span className="italic text-primary">Signature Drink</span>
            </h1>
            <p className="text-slate-400 text-lg max-w-2xl mx-auto font-light">
              From timeless classics to bold new mixes. Explore, experiment, and
              create signature drinks by ingredient or category worth
              remembering.
            </p>
          </section>

          <section className="mb-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-[100]">
            <form onSubmit={handleSubmit}>
              <div className="glass-panel p-2 rounded-2xl flex flex-col md:flex-row items-center gap-2 shadow-2xl">
                ...
                <div className="w-full md:w-64 relative">
                  ...
                  >
                    <span
                      className={
                        searchFilters.category ? "text-white" : "text-slate-500"
                      }
                    >
                ...
                <button
                  type="submit"
                  className="w-full md:w-auto px-10 h-14 bg-primary hover:bg-orange-500 text-navy-deep font-bold rounded-xl transition-all shadow-lg shadow-primary/20 active:scale-95"
                >
                  Search
                </button>
              </div>
