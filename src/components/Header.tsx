          ...
          <div className="mx-auto max-w-7xl px-6 py-24">
            <div className="grid gap-12 md:grid-cols-2 items-center">
              ...
              <form
                ...
                className="max-w-lg w-full bg-slate-900 rounded-2xl p-8 shadow-2xl space-y-6 order-2"
              >
                ...
                <div className="relative">
                  ...
                  {categoryOpen && (
                    <ul className="absolute z-10 mt-2 w-full rounded-lg bg-slate-800 shadow-xl overflow-hidden">
                      {categories.map((item) => (
                        <li
                ...
                <button
                  type="submit"
                  className="w-full rounded-lg bg-orange-400 text-white py-3 font-medium transition-all duration-200 hover:scale-[1.02]"
                >
                  Search Recipes
                </button>
              </form>
