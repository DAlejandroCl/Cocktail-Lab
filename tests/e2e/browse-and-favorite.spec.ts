...
test.describe("Browse and Favorite", () => {
  ...
  test.describe("Add favorite from drink card", () => {
    test("clicking the heart button adds the drink to favorites", async ({ homePage }) => {
      await homePage.goto();
    ...
    test("shows error notification when the lookup API fails", async ({ page, homePage }) => {
  ...
  test.describe("Add favorite from the Recipe Modal", () => {
    test("favorite button in modal adds the drink", async ({ homePage, recipeModal }) => {
      await homePage.goto();
      await homePage.browseAll();
    ...
    test("success notification appears after adding from modal", async ({ page, homePage, recipeModal }) => {
      await homePage.goto();
      await homePage.browseAll();
    ...
    test("adding from modal is reflected on the card heart button", async ({ homePage, recipeModal }) => {
      await homePage.goto();
      await homePage.browseAll();
  ...
  test.describe("Favorites page — after adding", () => {
    test("saved drink appears on the Favorites page", async ({ page, homePage }) => {
      await homePage.goto();
      await homePage.browseAll();
    ...
    test("favorites survive a client-side route change", async ({ page, homePage, favoritesPage }) => {
      await homePage.goto();
      await homePage.browseAll();
  ...
  test.describe("Remove favorite from home page", () => {
    test("clicking the active heart button removes the drink", async ({ homePage }) => {
      await homePage.goto();
      await homePage.browseAll();
  ...
  test.describe("Remove favorite from Favorites page", () => {
    test("removed drink disappears from the list", async ({ homePage, favoritesPage }) => {
      await homePage.goto();
      await homePage.browseAll();
    ...
    test("shows info notification after removing from Favorites page", async ({ homePage, favoritesPage }) => {
      await homePage.goto();
      await homePage.browseAll();
    ...
    test("removing the last favorite shows the empty state", async ({ homePage, favoritesPage }) => {
      await homePage.goto();
      await homePage.browseAll();
  ...
  test.describe("Remove favorite from the Recipe Modal", () => {
    test("toggling the favorite button in the modal removes the drink", async ({ homePage, recipeModal }) => {
      await homePage.goto();
      await homePage.browseAll();
    ...
    test("info notification appears after removing from modal", async ({ page, homePage, recipeModal }) => {
      await homePage.goto();
      await homePage.browseAll();
